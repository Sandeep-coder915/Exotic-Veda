...
export const beetrootDietaryRecipes = [
  ...
  },
  {
    ...
    dietaryType: 'Detox Drink',
    ingredients: [
      '1 teaspoon beetroot powder',
      '1 glass water or fruit juice'
    ],
    instructions: [
      'Mix beetroot powder with water or your favorite fruit juice.',
  ...
  },
  {
    ...
    dietaryType: 'Caffeine-Free Drink',
    ingredients: [
      '1 teaspoon beetroot powder',
    ...
    instructions: [
      'Mix beetroot powder with warm milk and sweetener.',
      'Whisk until frothy and fully combined.',
  ...
  {
    id: 4,
    title: 'Beetroot Salad Dressing',
    dietaryType: 'Salad Enhancer',
    ingredients: [
    ...
    instructions: [
      'Combine beetroot powder, olive oil, and apple cider vinegar in a bowl.',
  ...
  {
    id: 5,
    title: 'Beetroot Energy Bars',
    dietaryType: 'Healthy Snack',
    ingredients: [
      '1 teaspoon beetroot powder',
      '1 cup oats',
      '1/2 cup nuts (almonds, cashews, etc.)',
  ...
  },
  {
    id: 6,
    title: 'Beetroot Soup',
    dietaryType: 'Warm Meal',
    ingredients: [
      '1-2 teaspoons beetroot powder',
      '2 cups vegetable broth',
      '1/2 cup diced vegetables (carrots, celery, etc.)',
      'Salt and pepper to taste'
    ],
    instructions: [
      'In a pot, bring vegetable broth to a boil.',
      'Add diced vegetables and simmer until tender.',
      'Stir in beetroot powder and season with salt and pepper.',
